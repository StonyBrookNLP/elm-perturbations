...
class DAVAE(nn.Module):
    ...
    def forward(self, input, seq_lens, target, target_lens, beam_size=-1, str_out=False, max_len_decode=50, min_len_decode=0, n_best=1, encode_only=False):
        """
        Args
        ...
        return self.train(target, batch_size, dhidden, latent_values, diffs)
